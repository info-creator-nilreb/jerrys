...
- [ADR-0004: Product categories (browse taxonomy)](./0004-product-categories.md) — superseded in part by ADR-0010
- [ADR-0010: Categories via collections](./0010-category-via-collections.md)
...
- [ADR-0011: Admin self-service password change and TOTP MFA](./0011-admin-self-service-security.md) — Proposed
