/**
 * Versandbenachrichtigung im OrderlyEmails-/Shopify-ähnlichen Layout (600px, weiße Karte).
 */
...
<head>
  ...
  <title>Versand {{order.number}}</title>
  <!--[if mso]>
  <style type="text/css">
        ...
        <table role="presentation" class="email-container" width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="width:600px;min-width:600px;max-width:600px;margin:0 auto;">
          ...
          <tr>
            <td bgcolor="#ffffff" style="background:#ffffff;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:22px 44px 11px;font-family:${font};" align="center">
                    <h1 style="margin:0;font-size:28px;line-height:1.4;font-weight:400;color:${headingColor};">Deine Bestellung wurde versandt</h1>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};font-size:15px;line-height:1.55;color:${bodyColor};" align="center">
                    ...
                    <p style="margin:0;">wir freuen uns, dir mitteilen zu können, dass deine Bestellung versandt wurde!</p>
                  </td>
                </tr>
              </table>

              <!-- Rechnungshinweis (PDF-Anhang) -->
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};">
                    {{{order.invoice_note_html}}}
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};color:#333333;">
                    <h3 style="margin:0 0 12px;font-size:16px;line-height:1.4;font-weight:400;color:${headingColor};border-bottom:1px solid ${dividerColor};padding-bottom:8px;">Versandte Artikel</h3>
                    {{{order.items_html}}}
                  </td>
                </tr>
              </table>

              <!-- Versandadresse + Tracking -->
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;">
                    {{{order.shipping_address_tracking_html}}}
                  </td>
                </tr>
              </table>
              ...
              <!-- Sendungsverfolgung (nur wenn Tracking-URL vorhanden) -->
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};font-size:15px;line-height:1.55;color:${bodyColor};" align="center">
                    {{{order.tracking_section_html}}}
                  </td>
                </tr>
              </table>
