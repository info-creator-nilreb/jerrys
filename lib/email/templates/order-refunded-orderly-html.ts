/**
 * Erstattungsbenachrichtigung im OrderlyEmails-/Shopify-ähnlichen Layout (600px, weiße Karte).
 */
...
<head>
  ...
  <title>Erstattung {{order.number}}</title>
  <!--[if mso]>
  <style type="text/css">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:22px 44px 11px;font-family:${font};" align="center">
                    <h1 style="margin:0;font-size:28px;line-height:1.4;font-weight:400;color:${headingColor};">Rückerstattung</h1>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};font-size:15px;line-height:1.55;color:${bodyColor};" align="center">
                    ...
                    <p style="margin:0;">wir haben dir deine Bestellung erstattet. Bitte beachte, dass es einige Tage dauern kann, bis die Erstattung auf deinen Bank- oder Kreditkartenauszügen erscheint.</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};" align="center">
                    ...
                    <p style="margin:4px 0 0;font-size:13px;line-height:1.55;color:${mutedColor};">{{order.refund_date}}</p>
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0">
                <tr>
                  <td class="section-pad" style="padding:11px 44px;font-family:${font};color:#333333;">
                    <h3 style="margin:0 0 12px;font-size:16px;line-height:1.4;font-weight:400;color:${headingColor};border-bottom:1px solid ${dividerColor};padding-bottom:8px;">Artikel, für die der Kaufpreis erstattet wurde</h3>
                    {{{order.items_html}}}
